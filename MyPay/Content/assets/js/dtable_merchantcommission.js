...
function BindDataTable(tableId) {
    ...
    var MerchantUniqueId = $("#hdnMerchantUniqueId").val();
        ...
        setTimeout(
            function () {
                table = $('#tbllist').DataTable({
                    ...
                    bFilter: false,
                    "oLanguage": {
                        "sEmptyTable": "No Active Merchant Commissions  "
                    },
                    ...
                    "order": [[0, "desc"]],
                    "ajax": {
                        "url": "/MerchantCommissionSetup/GetMerchantCommissionLists",
                        "type": "POST",
                        "async": false,
                        data: function (data) {
                            data.IsDeleted = 0;
                            ...
                            data.CheckDefault = CommissionType;
                        },
                    ...
                    "columns": [
                        ...
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                var objIsDisables = (data.IsDefault ? "disabled onclick=\"alert('This is Default Slab of Commission Setup'); return false;\"  onkeypress='return false'  " : " onkeypress='return isNumberKey(this, event);'   ");
                                //var objIsDisables = "";
                                return '<span class="tb-status text-danger" > * </span><input type="text" id="MinimumAmount' + data.Id + '" ' + objIsDisables + ' maxlength="10" class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.MinimumAmount + '" ">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                var objIsDisables = (data.IsDefault ? "disabled onclick=\"alert('This is Default Slab of Commission Setup'); return false;\"  onkeypress='return false'  " : " onkeypress='return isNumberKey(this, event);'   ");
                                return '<span class="tb-status text-danger" > * </span><input type="text" id="MaximumAmount' + data.Id + '" ' + objIsDisables + ' maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.MaximumAmount + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        ...
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="FixedCommissionMerchant' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.FixedCommissionMerchant + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="PercentageCommissionMerchant' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.PercentageCommissionMerchant + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="MerchantContribution' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.MerchantContribution + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="Discount' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.Discount + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="FixedDiscount' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.FixedDiscount + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="MinimumDiscount' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.MinimumDiscount + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<input type="text" id="MaximumDiscount' + data.Id + '"  maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.MaximumDiscount + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                var objIsDisables = (data.IsDefault ? "disabled onclick=\"alert('This is Default Slab of Commission Setup'); return false;\"  onkeypress='return false'  " : " onkeypress='return isNumberKey(this, event);'   ");
                                return '<input type="text" id="TransactionCountLimit' + data.Id + '" ' + objIsDisables + '   maxlength="10"  class="form-control form-control-md form-control-outlined dttxtcontrol_inGrid" value="' + data.TransactionCountLimit + '" onkeypress="return isNumberKey(this, event);">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                var objIsDisables = (data.IsDefault ? "disabled onclick=\"alert('This is Default Slab of Commission Setup'); return false;\"  onkeypress='return false'  " : " onkeypress='return isNumberKey(this, event);'   ");
                                return '<input type="text" id="FromDateDT' + data.Id + '" ' + objIsDisables + '  readonly=readonly class="form-control form-control-md form-control-outlined datePicker dtdatecontrol_inGrid" value="' + data.FromDateDT + '">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                var objIsDisables = (data.IsDefault ? "disabled onclick=\"alert('This is Default Slab of Commission Setup'); return false;\"  onkeypress='return false'  " : " onkeypress='return isNumberKey(this, event);'   ");
                                return '<input type="text" id="ToDateDT' + data.Id + '" ' + objIsDisables + '  readonly=readonly class="form-control form-control-md form-control-outlined datePicker dtdatecontrol_inGrid" value="' + data.ToDateDT + '">';
                            },
                            autoWidth: true,
                            bSortable: false
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                var objDefaultType = '<input type="hidden" id="DefaultTypeId' + data.Id + '" value="' + data.IsDefault + '"/>';
                                objDefaultType = objDefaultType + '<span  class="tb-status text-' + (data.DefaultTypeName == "Regular" ? "success" : "") + '">' + data.DefaultTypeName + '</span>';
...
function AddCommissionRow() {
    ...
    if (ProviderId == "0") {
        ...
        $("#dvMsg").html("Please select Commission Type");
    }
    else {
        ...
        commission.MerchantUniqueId = MerchantUniqueId;
        commission.FixedCommissionMerchant = 0;
        commission.PercentageCommissionMerchant = 0;
        commission.MerchantContribution = 0;
        commission.Discount = 0;
        commission.TransactionCountLimit = 0;
        commission.FixedDiscount = 0;
        commission.MinimumDiscount = 0;
        commission.MaximumDiscount = 0;
        if (CommissionType == "0") {
        ...
        if (commission != null) {
            $.ajax({
                type: "POST",
                url: "/MerchantCommissionSetup/AddNewCommissionDataRow",
                ...
                success: function (response) {
                    ...
                    if (response != null) {
                        if (response == "Fail") {
                            $("#dvMsg").html("You cannot add ore than 1 Default Commission setup.");
                        }
                        else {
                            BindDataTable("tbllist");
...
function updatecommission(id) {
    ...
    var ServiceId = $("#ServiceId" + id).val(), ServiceCharge = $("#ServiceCharge" + id).val(); DefaultTypeId = $("#DefaultTypeId" + id).val();
    var FixedCommission = $("#FixedCommissionMerchant" + id).val(), PercentageCommission = $("#PercentageCommissionMerchant" + id).val(), MerchantContribution = $("#MerchantContribution" + id).val(), Discount = $("#Discount" + id).val(), TransactionCountLimit = $("#TransactionCountLimit" + id).val();
    var FixedDiscount = $("#FixedDiscount" + id).val(), MinimumDiscount = $("#MinimumDiscount" + id).val(), MaximumDiscount = $("#MaximumDiscount" + id).val();
    var MerchantUniqueId = $("#hdnMerchantUniqueId").val();
    if (min == "") {
    ...
    else if (FixedCommission == "") {
        $("#dvMsg").html("Please enter Fixed Commission");
        return false;
    }
    else if (PercentageCommission == "") {
        $("#dvMsg").html("Please enter Percentage Commission");
        return false;
    }
    else if (MerchantContribution == "") {
        $("#dvMsg").html("Please enter Merchant Contribution");
        return false;
    }
    else if (Discount == "") {
        $("#dvMsg").html("Please enter Discount");
        return false;
    }
    else if (TransactionCountLimit == "") {
        $("#dvMsg").html("Please enter Transaction Count Limit");
        return false;
    }
    else if (FixedDiscount == "") {
        $("#dvMsg").html("Please enter Fixed Discount");
        return false;
    }
    else if (MinimumDiscount == "") {
        $("#dvMsg").html("Please enter Minimum Discount");
        return false;
    }
    else if (MaximumDiscount == "") {
        $("#dvMsg").html("Please enter Maximum Discount");
        return false;
    }
    var commission = new Object();
    ...
    commission.MerchantUniqueId = MerchantUniqueId;
    commission.IsDefault = DefaultTypeId;
    commission.FixedCommissionMerchant = FixedCommission;
    commission.PercentageCommissionMerchant = PercentageCommission;
    commission.MerchantContribution = MerchantContribution;
    commission.Discount = Discount;
    commission.TransactionCountLimit = TransactionCountLimit;
    commission.FixedDiscount = FixedDiscount;
    commission.MinimumDiscount = MinimumDiscount;
    commission.MaximumDiscount = MaximumDiscount;
    var dd = JSON.stringify(commission);
    if (commission != null) {
        $.ajax({
            type: "POST",
            url: "/MerchantCommissionSetup/CommissionUpdateCall",
            data: JSON.stringify(commission),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            success: function (response) {
                ...
                if (response != null) {
                    if (response.Id == "0") {
                        ...
                        BindDataTable("tbllist");
                        $("#dvMsgSuccess").html("Merchant Commissions are successfully updated");
                        $("#anchor_addCommissionRow").show();
                        return true;
                    }
                }
...
function statusupdatecommission(id, activestatus) {
    ...
    if (commission != null) {
        $.ajax({
            type: "POST",
            url: "/MerchantCommissionSetup/StatusUpdateCommissionCall",
            data: JSON.stringify(commission),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
                ...
                if (response != null) {
                    if (response.Id != "0") {
                        ...
                        if (activestatus == "true")
                            $("#dvMsgSuccess").html("Merchant Commissions are successfully Published");
                        else
                            $("#dvMsgSuccess").html("Merchant Commissions are successfully Unpublished");
                        $("#anchor_addCommissionRow").show();
                        return true;
                    }
                }
...
function DeleteCommission(id) {
    ...
    if (confirm("Do you really want to delete commission ?")) {
        ...
        if (commission != null) {
            $.ajax({
                type: "POST",
                url: "/MerchantCommissionSetup/DeleteCommissionDataRow",
                data: JSON.stringify(commission),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    if (response != null) {
                        BindDataTable("tbllist");
                        $("#dvMsgSuccess").html("Merchant Commissions are successfully deleted");
                        return true;
                    } else {
                        $("#dvMsg").html("Something went wrong");
                        return false;
...
$(document).ready(function () {
    ...
    $("#drpProvider").on("change", function () {
        ...
        if (ProviderId != 0) {
            $.ajax({
                url: "/MerchantCommissionSetup/GetProviderServiceList",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    setTimeout(
        function () {
            table = $('#tblist').DataTable({
                ...
                "order": [[0, "asc"]],
                "ajax": {
                    "url": "/MerchantCommissionSetup/GetCommissionUpdateHistoryLists",
                    "type": "POST",
                    "async": false,
                    data: function (data) {
                        data.ServiceId = $("#drpProviderServices").val();
                        ...
                        data.ScheduleStatus = $("#EnumScheduleStatus").val();
                        data.MerchantUniqueId = $("#hdnMerchantUniqueId").val();
                    },
                    error: function (xhr, error, code) {
                        if (xhr.status == 200) {
                            alert('Session Timeout. Please login again to continue.');
    ...
    setTimeout(
        function () {
            table = $('#tblist').DataTable({
                ...
                "order": [[0, "desc"]],
                "ajax": {
                    "url": "/MerchantCommissionSetup/GetProviderServiceCategoriesLists",
                    "type": "POST",
                    "async": false,
                    data: function (data) {
                    },
...
function updateprovidercommission(id) {
    ...
    $.ajax({
        type: "POST",
        url: "/MerchantCommissionSetup/ProviderCommissionUpdate",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
