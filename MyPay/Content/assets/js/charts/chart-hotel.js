...
!function (NioApp, $) {
  ...
  var totalUsers = {
    ...
    datasets: [{
      label: "User",
      color: [NioApp.hexRGB("#f98c45", .2), NioApp.hexRGB("#f98c45", .2), NioApp.hexRGB("#f98c45", .2), NioApp.hexRGB("#f98c45", .2), NioApp.hexRGB("#f98c45", .2), NioApp.hexRGB("#f98c45", .2), "#f98c45"],
      // @v2.0
  ...
  var totalTransaction = {
    labels: ["01 Jan", "02 Jan", "03 Jan", "04 Jan", "05 Jan", "06 Jan", "07 Jan"],
    dataUnit: 'transaction',
    stacked: true,
    datasets: [{
      label: "User",
      color: [NioApp.hexRGB("#4acf1f", .2), NioApp.hexRGB("#4acf1f", .2), NioApp.hexRGB("#4acf1f", .2), NioApp.hexRGB("#4acf1f", .2), NioApp.hexRGB("#4acf1f", .2), NioApp.hexRGB("#4acf1f", .2), "#4acf1f"],
      // @v2.0
