...
!function (NioApp, $) {
  ...
  NioApp.coms.docReady.push(function () {
    ...
    debugger;
    var valuelabels = $('#input_hidden_elemsDate').val(); //retrieve array
    valuelabels = JSON.parse(valuelabels);

    var valuelabelsDebitTrans = $('#input_hidden_elemsDebitTransactions').val(); //retrieve array
    valuelabelsDebitTrans = JSON.parse(valuelabelsDebitTrans);

    var valuelabelsCreditTrans = $('#input_hidden_elemsCreditTransactions').val(); //retrieve array
    valuelabelsCreditTrans = JSON.parse(valuelabelsCreditTrans);
  ...
  var orderOverview = {
    ...
    label: "Debit",
    color: "#f98c45",
    data: valuelabelsDebitTrans
    }, {
      label: "Credit",
      color: "#4acf1f",
      data: valuelabelsCreditTrans
    }]
  };
