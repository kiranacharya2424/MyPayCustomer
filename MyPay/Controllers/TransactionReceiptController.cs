...
{
    public class TransactionReceiptController : Controller
    {
        ...
        public void ExportToPDF(string transactionid)
        {
            try
            {
                ...
                if (uw.GetRecord())
                {
                    ...
                    if (uw.Type == 29 || uw.Type == 121 || uw.Type == 124 || uw.Type == 125 || uw.Type == 126 || uw.Type == 45 || uw.Type == 58 || uw.Type == 68 || uw.Type == 69 || uw.Type == 75 || uw.Type == 78 || uw.Type == 106 || uw.Type == 107 || uw.Type == 108 || uw.Type == 109 || uw.Type == 110 || uw.Type == 111 || uw.Type == 112 || uw.Type == 113 || uw.Type == 114 || uw.Type == 115 || uw.Type == 116 || uw.Type == 200 || uw.Type == 300|| uw.Type == 79 || uw.Type == 202 || uw.Type == 204)
                    {
                        generateNewReceipt(transactionid);
                        return;
                    }
                    ...
                    else
                    {
                        ...
                        else if (uw.Type == ((int)VendorApi_CommonHelper.KhaltiAPIName.khalti_nea))
                        {
                            ...
                            if (response != null)
                            {
                                ...
                                //{
                                //    DueBills = "<table width='100%' class='table'><tbody>";

                                //    DueBills = DueBills + "<tr>";
                                //    DueBills = DueBills + "<td colspan='2'><b>   Bills Details </b> </td>";
                                //    DueBills = DueBills + "</tr>";

                                //    DueBills = DueBills + "<tr style='background:#efefef;'>";
                                //    DueBills = DueBills + "<td> Bill Amount </td>";
                                //    DueBills = DueBills + "<td>"+ response.Due_Bills[i].Bill_Amount+ "</td>";
                                //    DueBills = DueBills + "</tr>";

                                //    DueBills = DueBills + "<tr>";
                                //    DueBills = DueBills + "<td> Due Bill Of </td>";
                                //    DueBills = DueBills + "<td>" + response.Due_Bills[i].Due_Bill_Of + "</td>";
                                //    DueBills = DueBills + "</tr>";

                                //    DueBills = DueBills + "<tr style='background:#efefef;'>";
                                //    DueBills = DueBills + "<td> Payable Amount </td>";
                                //    DueBills = DueBills + "<td>" + response.Due_Bills[i].Payable_Amount + "</td>";
                                //    DueBills = DueBills + "</tr>";

                                //    DueBills = DueBills + "<tr>";
                                //    DueBills = DueBills + "<td> Status </td>";
                                //    DueBills = DueBills + "<td>" + response.Due_Bills[i].Status + "</td>";
                                //    DueBills = DueBills + "</tr>";


                                //    DueBills = DueBills + "</tbody></table>";
                                //}
            ...
            foreach (var data in jObject)
            {
                ...
                if (data.Key == "QR Code")
                {
                   ...
                   // var codeBitmap = new Bitmap(your_info);
                    ...
                    addTableRow(data.Key, data.Value.ToString());
        ...
        {
            sb.Append("<p style=\"text-align:center; width: 100%;max-width: 700px;\"><img alt=\"\" src=\"https://mypay.com.np/public/frontEnd/images/logo-dark.png\" style=\"height:50px; width:150px\" /></p>");
