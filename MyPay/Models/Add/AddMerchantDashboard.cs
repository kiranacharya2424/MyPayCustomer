...
{
    public class AddMerchantDashboard : CommonAdd
    {
        #region "Properties"
        ...
        private decimal _UserWalletBalance = 0;
        public decimal UserWalletBalance
        {
            get { return _UserWalletBalance; }
            set { _UserWalletBalance = value; }
        }
