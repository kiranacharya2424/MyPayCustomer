...
{
    public class AddRemittanceCurrencyList:CommonAdd
    {
        ...
        public bool Add()
        {
            try
            {
                ...
                string ResultId = obj.ExecuteProcedureGetReturnValue("sp_RemittanceCurrencyList_AddNew", HT);
        ...
        public bool Update()
        {
            try
            {
                ...
                System.Collections.Hashtable HT = SetObject();
                HT.Add("Id", Id);
                string ResultId = obj.ExecuteProcedureGetReturnValue("sp_RemittanceCurrencyList_Update", HT);
                if (!string.IsNullOrEmpty(ResultId) && ResultId != "0")
                {
                    Id = Convert.ToInt64(ResultId);
                    DataRecieved = true;
        ...
        public System.Data.DataTable GetList()
        {
            ...
            try
            {
                ...
                dt = obj.GetDataFromStoredProcedure("sp_RemittanceCurrencyList_Get", HT);
            }
            catch (Exception ex)
            {
                DataRecieved = false;
        ...
        public System.Data.DataTable GetData(string sortColumn, string sortOrder, int OffsetValue, int PagingSize, string SearchText)
        {
            ...
            try
            {
                ...
                dt = obj.GetDataFromStoredProcedure("sp_RemittanceCurrencyList_DataTable", HT);
                if (dt != null && dt.Rows.Count > 0)
                {
                    CommonHelpers obj1 = new CommonHelpers();
                    System.Data.DataTable dtCounter = obj1.GetDataFromStoredProcedure("sp_RemittanceCurrencyList_DataTableCounter", HT);
        ...
        public System.Data.DataTable GetUnassignedCurrencyList()
        {
            System.Data.DataTable dt = new System.Data.DataTable();
            try
            {
                ...
                dt = obj.GetDataFromStoredProcedure("sp_RemittanceFilteredCurrencyList_Get", HT);
            }
            catch (Exception ex)
            {
                DataRecieved = false;
