...
{
    public class AddMerchantCommissionHistory:CommonAdd
    {
        #region "Enums"
        ...
        private Int64 _MerchantCommissionId = 0;
        public Int64 MerchantCommissionId
        {
            get { return _MerchantCommissionId; }
            set { _MerchantCommissionId = value; }
        }
        ...
        public bool Add()
        {
            try
            {
                ...
                string ResultId = obj.ExecuteProcedureGetReturnValue("sp_MerchantCommissionHistory_AddNew", HT);
        ...
        public bool Update()
        {
            try
            {
                ...
                System.Collections.Hashtable HT = SetObject();
                HT.Add("Id", Id);
                string ResultId = obj.ExecuteProcedureGetReturnValue("sp_MerchantCommissionHistory_Update", HT);
                if (!string.IsNullOrEmpty(ResultId) && ResultId != "0")
                {
                    Id = Convert.ToInt64(ResultId);
                    DataRecieved = true;
        ...
        public System.Collections.Hashtable SetObject()
        {
            ...
            HT.Add("MerchantCommissionId", MerchantCommissionId);
        ...
        public System.Data.DataTable GetData(string sortColumn, string sortOrder, int OffsetValue, int PagingSize, string SearchText)
        {
            ...
            try
            {
                ...
                HT.Add("MerchantCommissionId", MerchantCommissionId);
                HT.Add("CheckIsDefault", CheckIsDefault);
                dt = obj.GetDataFromStoredProcedure("sp_MerchantCommissionHistory_Datatable", HT);
                if (dt != null && dt.Rows.Count > 0)
                {
                    DataRecieved = true;
                }
