...
namespace MyPay.Models.VendorAPI.Get.Insurance.Jyoti
{
    public class GetVendor_API_ServiceGroup_JyotiLifeInsurance_Commit
    {
        // Id 
        private int _id = 0;
        public int id
        ...
        public JyotiLifeExtraData extra_data { get; set; }
    }
    public class JyotiLifeExtraData
    {
    }
}