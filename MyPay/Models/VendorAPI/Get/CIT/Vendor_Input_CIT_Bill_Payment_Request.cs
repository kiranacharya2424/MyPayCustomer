...
{
    public class Vendor_Input_CIT_Bill_Payment_Request
    {
        ...
        private CITBatchDetail _cipsBatchDetail = new CITBatchDetail();
        public CITBatchDetail cipsBatchDetail
        {
            get { return _cipsBatchDetail; }
            set { _cipsBatchDetail = value; }
        }
        private CITTransactionDetail _cipsTransactionDetail = new CITTransactionDetail();
        public CITTransactionDetail cipsTransactionDetail
        {
            get { return _cipsTransactionDetail; }
            set { _cipsTransactionDetail = value; }
        }
    }
