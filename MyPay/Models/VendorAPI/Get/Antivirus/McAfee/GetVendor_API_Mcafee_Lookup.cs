...
{
    public class GetVendor_API_Mcafee_Lookup : CommonGet
    {
        ...
        // Kaspersky_data
        private List<Mcafee_bills> _data = new List<Mcafee_bills>();
        public List<Mcafee_bills> data
        {
