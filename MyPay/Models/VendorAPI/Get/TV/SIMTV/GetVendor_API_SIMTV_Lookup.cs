...
{
    public class GetVendor_API_SIMTV_Lookup : CommonGet
    {
        ...
        // SIMTV_Lookup_Data
        private SIMTV_Lookup_Data _data = new SIMTV_Lookup_Data();
        public SIMTV_Lookup_Data data
        {
    ...
    public class SIMTV_Lookup_Data
    {
        // name
