...
{
    public class GetVendor_API_Dishome_FTTH_Lookup : CommonGet
    {
        ...
        // Dishome_Lookup_Data
        private Dishome_FTTH_Lookup_Data _data = new Dishome_FTTH_Lookup_Data();
        public Dishome_FTTH_Lookup_Data data
        {
        ...
        private Dishome_FTTH_Error_Data _error_data = new Dishome_FTTH_Error_Data();
        public Dishome_FTTH_Error_Data error_data
        {
        ...
        private Dishome_FTTH_Error_Data _details = new Dishome_FTTH_Error_Data();
        public Dishome_FTTH_Error_Data details
        {
    ...
    public class Dishome_FTTH_Lookup_Data
    {
        // name
    ...
    public class Dishome_FTTH_Error_Data
    {
