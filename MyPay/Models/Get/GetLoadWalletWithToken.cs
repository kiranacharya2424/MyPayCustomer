...
{
    public class GetLoadWalletWithToken
    {
        //code
        ...
        //data
        private dataLoadWalletWithToken _data = new dataLoadWalletWithToken();
        public dataLoadWalletWithToken data
        {
            get { return _data; }
            set { _data = value; }
        }
    ...
    public class dataLoadWalletWithToken
    {
