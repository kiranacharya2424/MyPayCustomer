...
{
    public class GetMerchantBankDetail:CommonGet
    {
        #region "Properties"
        //MerchantId
        ...
        public DataTable GetData(string sortColumn, string sortOrder, int OffsetValue, int PagingSize, string SearchText)
        {
            ...
            try
            {
                ...
                dt = obj.GetDataFromStoredProcedure("sp_MerchantBankDetail_Datatable", HT);
                if (dt != null && dt.Rows.Count > 0)
                {
                    Common.CommonHelpers obj1 = new Common.CommonHelpers();
                    DataTable dtCounter = obj1.GetDataFromStoredProcedure("sp_MerchantBankDetail_DatatableCounter", HT);
        ...
        public DataTable GetList()
        {
            ...
            try
            {
                ...
                HT.Add("Weekly", Weekly);
                HT.Add("Monthly", Monthly);
                dt = obj.GetDataFromStoredProcedure("sp_MerchantBankDetail_Get", HT);
            }
            catch (Exception ex)
            {
                //DataRecieved = false;
