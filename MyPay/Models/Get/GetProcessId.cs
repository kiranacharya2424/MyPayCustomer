...
namespace MyPay.Models.Get
{
    public class GetProcessId
    {
        ...
        //errors
        private List<Errors_Process> _errors = new List<Errors_Process>();
        public List<Errors_Process> errors
        {
            get { return _errors; }
            set { _errors = value; }
        }
        ...
        //data
        private dataProcess _data = new dataProcess();
