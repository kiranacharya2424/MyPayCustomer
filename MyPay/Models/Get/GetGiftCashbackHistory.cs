...
{
    public class GetGiftCashbackHistory:CommonGet
    {
        #region "Properties"
        //ContactNumber
        ...
        public DataTable GetData(string sortColumn, string sortOrder, int OffsetValue, int PagingSize, string SearchText)
        {
            ...
            try
            {
                ...
                dt = obj.GetDataFromStoredProcedure("sp_GiftCashbackHistory_Datatable", HT);
                if (dt != null && dt.Rows.Count > 0)
                {
                    Common.CommonHelpers obj1 = new Common.CommonHelpers();
                    DataTable dtCounter = obj1.GetDataFromStoredProcedure("sp_GiftCashbackHistory_DatatableCounter", HT);
