...
namespace MyPay.Repository
{
    public class Cryptograph
    {
        ...
        public static string Encrypt(string plainText, string publicXml)
        {
            RSACryptoServiceProvider rsaPublic = new RSACryptoServiceProvider();
            rsaPublic.FromXmlString(publicXml);
            byte[] toEncryptData = Encoding.ASCII.GetBytes(plainText);
            byte[] encryptedRSA = rsaPublic.Encrypt(toEncryptData, false);
            string EncryptedResult = Encoding.Default.GetString(encryptedRSA);
            return EncryptedResult;
        }

        public static string Decrypt(string encryptedText, string privateXml)
        {
            var rsaPrivate = new RSACryptoServiceProvider();
            rsaPrivate.FromXmlString(privateXml);
            byte[] encryptedRSA = Encoding.ASCII.GetBytes(encryptedText);
