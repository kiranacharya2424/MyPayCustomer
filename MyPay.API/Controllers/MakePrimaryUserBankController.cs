...
{
    public class MakePrimaryUserBankController : ApiController
    {
        private static ILog log = LogManager.GetLogger(typeof(MakePrimaryUserBankController));
        public HttpResponseMessage Post(Req_UserBankDetail user)
        {
            log.Info($"{System.DateTime.Now.ToString()} inside MakePrimaryUserBankController" + Environment.NewLine);
            ...
            try
            {
                ...
                else
                {
                    ...
                    string msg = RepUser.MakePrimaryUserBank(authenticationToken, user.MemberId, user.BankCode, user.PlatForm, true, user.DeviceCode);
                    ...
                    else
                    {
                        ...
                        log.Info($"{System.DateTime.Now.ToString()} MakePrimaryUserBankController completed" + Environment.NewLine);
                        return response;
                    }
                }
            }
            ...
            {
                log.Error($"{System.DateTime.Now.ToString()} MakePrimaryUserBankController {ex.ToString()} " + Environment.NewLine);
