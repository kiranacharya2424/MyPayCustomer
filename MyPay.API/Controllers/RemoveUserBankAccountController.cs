...
{
    public class RemoveUserBankAccountController : ApiController
    {
        private static ILog log = LogManager.GetLogger(typeof(RemoveUserBankAccountController));
        public HttpResponseMessage Post(Req_RemoveUserBankAccount user)
        {
            log.Info($"{System.DateTime.Now.ToString()} inside RemoveUserBankAccountController" + Environment.NewLine);
            ...
            try
            {
                ...
                else
                {
                    ...
                    string msg = RepUser.RemoveUserBankAccount(authenticationToken, resuserdetails.MemberId, user.BankId, user.PlatForm, true, user.DeviceCode);
                    ...
                    else
                    {
                        ...
                        log.Info($"{System.DateTime.Now.ToString()} RemoveUserBankAccountController completed" + Environment.NewLine);
                        return response;
                    }
                }
            }
            ...
            {
                log.Error($"{System.DateTime.Now.ToString()} RemoveUserBankAccountController {ex.ToString()} " + Environment.NewLine);
