...
{
    public class RequestAPI_EventsControllerV2 : ApiController
    {
                ...
                else
                {
                    ...
                    else
                    {
                        if (!string.IsNullOrEmpty(user.MemberId.ToString()) && user.MemberId.ToString() != "0")
                        {
                            ...
                            HttpResponseMessage responseFromSecondMethod = ServiceGroupEventTicketCommit(newReq);
