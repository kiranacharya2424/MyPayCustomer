...
{
    public class Req_Vendor_API_Epf_Commit_Requests : CommonProp
    {
        ...
        public CipsBatchDetail CipsBatch { get; set; }
        public CipsTransactionDetail CipsTransaction { get; set; }
