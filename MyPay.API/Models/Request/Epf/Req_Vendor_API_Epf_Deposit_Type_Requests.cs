...
{
    public class Req_Vendor_API_Epf_Deposit_Type_Requests : CommonProp
    {
        ...
        private CipsBatchDetailDeposit _CipsBatch = new CipsBatchDetailDeposit();
        public CipsBatchDetailDeposit CipsBatch
        {
            get { return _CipsBatch; }
            set { _CipsBatch = value; }
        }
        private CipsTransactionDetailDeposit _CipsTransaction = new CipsTransactionDetailDeposit();
        public CipsTransactionDetailDeposit CipsTransaction
        {
            get { return _CipsTransaction; }
            set { _CipsTransaction = value; }
        }
        public class CipsBatchDetailDeposit
        {
        ...
        public class CipsTransactionDetailDeposit
        {
