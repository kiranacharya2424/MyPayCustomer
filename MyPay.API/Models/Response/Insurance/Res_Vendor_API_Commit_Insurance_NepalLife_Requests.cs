...
{
    public class Res_Vendor_API_Commit_Insurance_NepalLife_Requests:CommonResponse
    {
        // TransactionDatetime
        ...
        private NepalLifeExtraData _ExtraData = new NepalLifeExtraData();

    }

    public class NepalLifeExtraData
    {
