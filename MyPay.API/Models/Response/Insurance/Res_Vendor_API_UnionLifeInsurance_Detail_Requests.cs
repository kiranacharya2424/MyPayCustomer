...
{
    public class Res_Vendor_API_UnionLifeInsurance_Detail_Requests : CommonResponse
    {
        ...
        private UnionLifeInsuranceErrorResponse _ErrorResponse = new UnionLifeInsuranceErrorResponse();
        public UnionLifeInsuranceErrorResponse ErrorResponse
        {
            get { return _ErrorResponse; }
            set { _ErrorResponse = value; }
        }
    }
    public class UnionLifeInsuranceErrorResponse
    {
